  ...
  })(
    {
        ...
        function(require, module, exports) {
          ...
          lp.parseExprAtom = function() {
            ...
            switch (this.tok.type) {
              ...
              case tt._super:
                var type =
                  this.tok.type === tt._this ? 'ThisExpression' : 'Super';
                node = this.startNode();
                this.next();
              ...
              case tt._false:
                node = this.startNode();
                node.value =
                  this.tok.type === tt._null
                    ? null
                    : this.tok.type === tt._true;
        ...
        function(require, module, exports) {
          ...
          lp.lineEnd = function(pos) {
            while (
              ...
              !isNewLine(this.input.charCodeAt(pos))
            )
              ++pos;
            return pos;
          };
      ...
      6: [
        function(require, module, exports) {
          ...
          lp.parseForIn = function(node, init) {
            var type =
              this.tok.type === tt._in ? 'ForInStatement' : 'ForOfStatement';
            this.next();
            node.left = init;
          ...
          lp.parseExportSpecifierList = function() {
            ...
            while (
              ...
              var elt = this.startNode();
              elt.local = this.parseIdent();
              elt.exported = this.eatContextual('as')
                ? this.parseIdent()
                : elt.local;
      ...
      7: [
        function(require, module, exports) {
          ...
          function isSpace(ch) {
            return (
              (ch < 14 && ch > 8) || ch === 32 || ch === 160 || isNewLine(ch)
            );
          }

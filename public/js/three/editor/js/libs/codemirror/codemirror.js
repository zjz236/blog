...
(function(mod) {
  ...
  var mobile =
    ios ||
    /Android|webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(userAgent);
  ...
  ContentEditableInput.prototype = copyObj(
    {
      ...
      applyComposition: function(composing) {
        if (this.cm.isReadOnly()) operation(this.cm, regChange)(this.cm);
  ...
  function onScrollWheel(cm, e) {
    ...
    if (dx && !gecko && !presto && wheelPixelsPerUnit != null) {
      ...
      // is large (issue #3579)
      if (!dy || canScrollY) e_preventDefault(e);
  ...
  CodeMirror.prototype = {
    ...
    heightAtLine: function(line, mode) {
      ...
      return (
        intoCoordSystem(this, lineObj, { top: 0, left: 0 }, mode || 'page')

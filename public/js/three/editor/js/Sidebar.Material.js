...
var SidebarMaterial = function(editor) {
  ...
  materialDepthPackingRow.add(
    new UIText(strings.getKey('sidebar/material/depthPacking')).setWidth(
      '90px',
    ),
  );
  ...
  materialSkinningRow.add(
    new UIText(strings.getKey('sidebar/material/skinning')).setWidth('90px'),
  );
  ...
  var materialEnvMap = new UITexture(THREE.SphericalReflectionMapping).onChange(
    updateMaterial,
  );

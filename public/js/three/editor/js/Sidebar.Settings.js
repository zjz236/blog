...
var SidebarSettings = function(editor) {
  ...
  var exportPrecision = new UIInteger(
    config.getKey('exportPrecision'),
  ).setRange(2, Infinity);
  ...
  exportPrecisionRow.add(
    new UIText(strings.getKey('sidebar/settings/exportPrecision')).setWidth(
      '90px',
    ),
  );

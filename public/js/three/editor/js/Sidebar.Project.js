...
var SidebarProject = function(editor) {
  ...
  var title = new UIInput(config.getKey('project/title'))
    .setLeft('100px')
    .onChange(function() {
  ...
  titleRow.add(
    new UIText(strings.getKey('sidebar/project/title')).setWidth('90px'),
  );
  titleRow.add(title);
  ...
  var editable = new UICheckbox(config.getKey('project/editable'))
    .setLeft('100px')
    .onChange(function() {
  ...
  editableRow.add(
    new UIText(strings.getKey('sidebar/project/editable')).setWidth('90px'),
  );
  ...
  var vrRow = new UIRow();
  var vr = new UICheckbox(config.getKey('project/vr'))
    .setLeft('100px')
    .onChange(function() {
  ...
  shadowTypeRow.add(
    new UIText(strings.getKey('sidebar/project/shadowType')).setWidth('90px'),
  );
  ...
  toneMappingExposureRow.add(
    new UIText(strings.getKey('sidebar/project/toneMappingExposure')).setWidth(
      '90px',
    ),
  );
  ...
  var toneMappingWhitePoint = new UINumber(
  ...
  toneMappingWhitePointRow.add(
    new UIText(
      strings.getKey('sidebar/project/toneMappingWhitePoint'),
    ).setWidth('90px'),
  );
  toneMappingWhitePointRow.add(toneMappingWhitePoint);
  rendererPanel.add(toneMappingWhitePointRow);
  toneMappingWhitePointRow.setDisplay(
    config.getKey('project/renderer/toneMapping') === 3 ? 'block' : 'none',
  );

...
import { zero3, one3, two3 } from './Constants.tests';
...
export default QUnit.module('Maths', () => {
  QUnit.module('Triangle', () => {
    ...
    QUnit.test('getMidpoint', assert => {
      ...
      assert.ok(
        a.getMidpoint(midpoint).equals(new Vector3(0, 0, 0)),
        'Passed!',
      );
      ...
      assert.ok(
        a.getMidpoint(midpoint).equals(new Vector3(1 / 3, 1 / 3, 0)),
        'Passed!',
      );
      ...
      assert.ok(
        a.getMidpoint(midpoint).equals(new Vector3(2 / 3, 0, 2 / 3)),
        'Passed!',
      );
    });
    ...
    QUnit.test('getBarycoord', assert => {
      ...
      assert.ok(
        barycoord.distanceTo(new Vector3(1 / 3, 1 / 3, 1 / 3)) < 0.0001,
        'Passed!',
      );

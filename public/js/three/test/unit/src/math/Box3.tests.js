...
export default QUnit.module('Maths', () => {
  QUnit.module('Box3', () => {
    ...
    QUnit.test('setFromBufferAttribute', assert => {
      var a = new Box3(zero3.clone(), one3.clone());
      var bigger = new BufferAttribute(
        new Float32Array([-2, -2, -2, 2, 2, 2, 1.5, 1.5, 1.5, 0, 0, 0]),
        3,
      );
      var smaller = new BufferAttribute(
    ...
    QUnit.test('expandByPoint', assert => {
      ...
      assert.ok(
        a.getSize(size).equals(one3.clone().multiplyScalar(2)),
        'Passed!',
      );
      assert.ok(a.getCenter(center).equals(zero3), 'Passed!');
    });
    ...
    QUnit.test('expandByObject', assert => {
      ...
      assert.ok(
        a.min.equals(new Vector3(-1, -1, -1)),
        'Bigger box: correct new minimum',
      );
      assert.ok(
        a.max.equals(new Vector3(1, 1, 1)),
        'Bigger box: correct new maximum',
      );
      ...
      assert.ok(
        ...
        'Translated, bigger box: correct new minimum',
      );
      assert.ok(
        a.max.equals(new Vector3(3, 1, 1)),
        'Translated, bigger box: correct new maximum',
      );
      ...
      assert.ok(
        a.min.equals(new Vector3(0, -1, -1)),
        'Translated, bigger box with child: correct new minimum',
      );
      assert.ok(
        a.max.equals(new Vector3(3, 1, 1)),
        'Translated, bigger box with child: correct new maximum',
      );
      ...
      assert.ok(
        a.min.equals(new Vector3(-0.25, -0.25, -0.25)),
        'Smaller box: correct new minimum',
      );
      assert.ok(
        a.max.equals(new Vector3(1, 1, 1)),
        'Smaller box: correct new maximum',
      );
    ...
    QUnit.test('distanceToPoint', assert => {
      ...
      assert.ok(
        a.distanceToPoint(new Vector3(1, 1, 1)) == Math.sqrt(3),
        'Passed!',
      );
      assert.ok(
        a.distanceToPoint(new Vector3(-1, -1, -1)) == Math.sqrt(3),
      ...
      assert.ok(
        b.distanceToPoint(new Vector3(2, 2, 2)) == Math.sqrt(3),
        'Passed!',
      );
    ...
    QUnit.test('getBoundingSphere', assert => {
      ...
      assert.ok(
        a.getBoundingSphere(sphere).equals(new Sphere(zero3, 0)),
        'Passed!',
      );
      assert.ok(
        b
          ...
          .equals(
            new Sphere(one3.clone().multiplyScalar(0.5), Math.sqrt(3) * 0.5),
          ),
        'Passed!',
      );
      assert.ok(
        c
          .getBoundingSphere(sphere)
          .equals(new Sphere(zero3, Math.sqrt(12) * 0.5)),
        'Passed!',
      );
    });
    ...
    QUnit.test('applyMatrix4', assert => {
      ...
      assert.ok(
        compareBox(a.clone().applyMatrix4(m), a.clone().translate(t1)),
        'Passed!',
      );
      assert.ok(
        compareBox(b.clone().applyMatrix4(m), b.clone().translate(t1)),
        'Passed!',
      );
      assert.ok(
        compareBox(c.clone().applyMatrix4(m), c.clone().translate(t1)),
        'Passed!',
      );
      assert.ok(
        compareBox(d.clone().applyMatrix4(m), d.clone().translate(t1)),
        'Passed!',
      );
    });

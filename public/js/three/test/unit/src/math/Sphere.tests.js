...
export default QUnit.module('Maths', () => {
  QUnit.module('Sphere', () => {
    ...
    QUnit.test('setFromPoints', assert => {
      ...
      assert.ok(
        Math.abs(a.center.x - expectedCenter.x) <= eps,
        'Default center: check center.x',
      );
      assert.ok(
        Math.abs(a.center.y - expectedCenter.y) <= eps,
        'Default center: check center.y',
      );
      assert.ok(
        Math.abs(a.center.z - expectedCenter.z) <= eps,
        'Default center: check center.z',
      );
      assert.ok(
        Math.abs(a.radius - expectedRadius) <= eps,
      ...
      assert.ok(
        Math.abs(a.center.x - optionalCenter.x) <= eps,
        'Optional center: check center.x',
      );
      assert.ok(
        Math.abs(a.center.y - optionalCenter.y) <= eps,
        'Optional center: check center.y',
      );
      assert.ok(
        Math.abs(a.center.z - optionalCenter.z) <= eps,

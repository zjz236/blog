...
export default QUnit.module('Maths', () => {
  QUnit.module('Frustum', () => {
    ...
    QUnit.test(
      'setFromProjectionMatrix/makeOrthographic/containsPoint',
      assert => {
    ...
    QUnit.test(
      'setFromProjectionMatrix/makePerspective/containsPoint',
      assert => {
        ...
        assert.ok(
          a.containsPoint(new Vector3(-99.999, -99.999, -99.999)),
          'Passed!',
        );
        assert.ok(
          !a.containsPoint(new Vector3(-100.1, -100.1, -100.1)),
          'Passed!',
        );
        assert.ok(
          a.containsPoint(new Vector3(99.999, 99.999, -99.999)),
    ...
    QUnit.test(
      'setFromProjectionMatrix/makePerspective/intersectsSphere',
      assert => {
        var m = new Matrix4().makePerspective(-1, 1, 1, -1, 1, 100);
        var a = new Frustum().setFromProjectionMatrix(m);

        assert.ok(
          !a.intersectsSphere(new Sphere(new Vector3(0, 0, 0), 0)),
          'Passed!',
        );
        assert.ok(
          !a.intersectsSphere(new Sphere(new Vector3(0, 0, 0), 0.9)),
          'Passed!',
        );
        assert.ok(
          a.intersectsSphere(new Sphere(new Vector3(0, 0, 0), 1.1)),
          'Passed!',
        );
        assert.ok(
          a.intersectsSphere(new Sphere(new Vector3(0, 0, -50), 0)),
          'Passed!',
        );
        assert.ok(
          a.intersectsSphere(new Sphere(new Vector3(0, 0, -1.001), 0)),
          'Passed!',
        );
        assert.ok(
          a.intersectsSphere(new Sphere(new Vector3(-1, -1, -1.001), 0)),
          'Passed!',
        );
        assert.ok(
        ...
        assert.ok(
          a.intersectsSphere(new Sphere(new Vector3(0, 0, -99.999), 0)),
          'Passed!',
        );
        assert.ok(
          a.intersectsSphere(
            new Sphere(new Vector3(-99.999, -99.999, -99.999), 0),
          ),
          'Passed!',
        );
        assert.ok(
          !a.intersectsSphere(
            new Sphere(new Vector3(-100.1, -100.1, -100.1), 0),
          ),
          'Passed!',
        );
        assert.ok(
          a.intersectsSphere(
            new Sphere(new Vector3(-100.1, -100.1, -100.1), 0.5),
          ),
          'Passed!',
        );
        assert.ok(
        ...
        assert.ok(
          a.intersectsSphere(
            new Sphere(new Vector3(100.1, 100.1, -100.1), 0.2),
          ),
          'Passed!',
        );
        assert.ok(
          !a.intersectsSphere(new Sphere(new Vector3(0, 0, -101), 0)),
          'Passed!',
        );
        assert.ok(
          a.intersectsSphere(new Sphere(new Vector3(0, 0, -101), 1.1)),
          'Passed!',
        );
      },
    );

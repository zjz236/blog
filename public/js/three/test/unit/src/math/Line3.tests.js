...
import { x, y, z, zero3, one3, two3 } from './Constants.tests';
...
export default QUnit.module('Maths', () => {
  QUnit.module('Line3', () => {
    ...
    QUnit.test('closestPointToPoint/closestPointToPointParameter', assert => {
      ...
      // nearby the ray
      assert.ok(
        a.closestPointToPointParameter(zero3.clone(), true) == 0,
        'Passed!',
      );
      ...
      // nearby the ray
      assert.ok(
        a.closestPointToPointParameter(zero3.clone(), false) == -1,
        'Passed!',
      );
      ...
      // nearby the ray
      assert.ok(
        a.closestPointToPointParameter(new Vector3(1, 1, 5), true) == 1,
        'Passed!',
      );
      ...
      // exactly on the ray
      assert.ok(
        a.closestPointToPointParameter(one3.clone(), true) == 0,
        'Passed!',
      );
    ...
    QUnit.test('applyMatrix4', assert => {
      ...
      assert.ok(
        a.end.equals(new Vector3(2 + x, 2 + y, 2 + z)),

...
export default QUnit.module('Animation', () => {
  QUnit.module('AnimationAction', () => {
    ...
    QUnit.test('reset', assert => {
      ...
      assert.equal(
        animationAction2.paused,
        false,
        'AnimationAction.reset() sets paused false',
      );
      assert.equal(
        animationAction2.enabled,
        true,
        'AnimationAction.reset() sets enabled true',
      );
      assert.equal(
        animationAction2.time,
        0,
        'AnimationAction.reset() resets time.',
      );
      assert.equal(
        animationAction2._loopCount,
        -1,
        'AnimationAction.reset() resets loopcount.',
      );
      assert.equal(
        animationAction2._startTime,
        null,
    ...
    QUnit.test('crossFadeFrom', assert => {
      ...
      assert.equal(
        animationAction2.getEffectiveWeight(),
        1,
        'When an animation crossFadeFrom is started, EffectiveWeight is 1.',
      );
      mixer.update(250);

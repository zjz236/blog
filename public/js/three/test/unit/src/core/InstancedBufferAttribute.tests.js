...
export default QUnit.module('Core', () => {
  QUnit.module('InstancedBufferAttribute', () => {
    ...
    QUnit.test('Instancing', assert => {
      ...
      var instance = new InstancedBufferAttribute(
        new Float32Array(10),
        2,
        false,
        123,
    ...
    QUnit.test('copy', assert => {
      ...
      assert.ok(
        copiedInstance instanceof InstancedBufferAttribute,
      ...
      assert.ok(
        copiedInstance.meshPerAttribute === 123,
        'meshPerAttribute was copied',
      );

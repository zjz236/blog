...
var files = [
  ...
  },
  {
    ...
    dependencies: [
      { name: 'CCDIKSolver', path: 'animation/CCDIKSolver.js' },
      { name: 'MMDPhysics', path: 'animation/MMDPhysics.js' },
    ],
...

  {
    ...
    dependencies: [
      { name: 'BokehShader', path: 'shaders/BokehShader2.js' },
      { name: 'BokehDepthShader', path: 'shaders/BokehShader2.js' },
    ],
    ignoreList: [],
  },
  ...
  { path: 'curves/CurveExtras.js', dependencies: [], ignoreList: [] },
  {
    ...
    dependencies: [{ name: 'NURBSUtils', path: 'curves/NURBSUtils.js' }],
    ignoreList: [],
  },
  {
  ...
  },
  {
    ...
    dependencies: [{ name: 'MMDParser', path: 'libs/mmdparser.module.js' }],
    ignoreList: [],
  },
  ...
  { path: 'geometries/BoxLineGeometry.js', dependencies: [], ignoreList: [] },
  {
    ...
    dependencies: [{ name: 'ConvexHull', path: 'math/ConvexHull.js' }],
    ignoreList: [],
  },
  { path: 'geometries/DecalGeometry.js', dependencies: [], ignoreList: [] },
  {
    path: 'geometries/LightningStrike.js',
    dependencies: [{ name: 'SimplexNoise', path: 'math/SimplexNoise.js' }],
    ignoreList: ['Mesh'],
  },
  {
...

  {
    path: 'lines/Line2.js',
    dependencies: [
      { name: 'LineSegments2', path: 'lines/LineSegments2.js' },
      { name: 'LineGeometry', path: 'lines/LineGeometry.js' },
      { name: 'LineMaterial', path: 'lines/LineMaterial.js' },
    ],
    ignoreList: [],
  },
  {
    ...
    dependencies: [
      { name: 'LineSegmentsGeometry', path: 'lines/LineSegmentsGeometry.js' },
    ],
    ignoreList: [],
  },
...

  {
    ...
    dependencies: [{ name: 'JSZip', path: 'libs/jszip.module.min.js' }],
    ignoreList: [],
  },
  {
  ...
  { path: 'loaders/BVHLoader.js', dependencies: [], ignoreList: ['Bones'] },
  {
    ...
    dependencies: [{ name: 'TGALoader', path: 'loaders/TGALoader.js' }],
    ignoreList: [],
  },
  ...
  },
  {
    ...
    dependencies: [{ name: 'Zlib', path: 'libs/inflate.module.min.js' }],
    ignoreList: [],
  },
  {
    path: 'loaders/FBXLoader.js',
    dependencies: [
      { name: 'Zlib', path: 'libs/inflate.module.min.js' },
      { name: 'NURBSCurve', path: 'curves/NURBSCurve.js' },
    ],
    ignoreList: [],
  },
  ...
  },
  {
    ...
    dependencies: [{ name: 'RGBELoader', path: 'loaders/RGBELoader.js' }],
    ignoreList: [],
  },
  {
    path: 'loaders/KMZLoader.js',
    dependencies: [
      { name: 'ColladaLoader', path: 'loaders/ColladaLoader.js' },
      { name: 'JSZip', path: 'libs/jszip.module.min.js' },
    ],
    ignoreList: [],
  },
  {
  ...
  { path: 'loaders/MD2Loader.js', dependencies: [], ignoreList: [] },
  {
    ...
    dependencies: [
      { name: 'TGALoader', path: 'loaders/TGALoader.js' },
      { name: 'MMDParser', path: 'libs/mmdparser.module.js' },
    ],
  ...
  },
  {
    ...
    dependencies: [
      { name: 'Zlib', path: 'libs/gunzip.module.min.js' },
      { name: 'Volume', path: 'misc/Volume.js' },
    ],
    ignoreList: [],
  },
  ...
  },
  {
    ...
    dependencies: [],
    ignoreList: ['Mesh', 'MeshPhongMaterial'],
  },
  ...
  { path: 'loaders/TGALoader.js', dependencies: [], ignoreList: [] },
  {
    ...
    dependencies: [{ name: 'opentype', path: 'libs/opentype.module.min.js' }],
    ignoreList: ['Font'],
  },
  {
    path: 'loaders/VRMLLoader.js',
    dependencies: [
      { name: 'chevrotain', path: 'libs/chevrotain.module.min.js' },
    ],
    ignoreList: [],
  },
  {
    path: 'loaders/VRMLoader.js',
    dependencies: [{ name: 'GLTFLoader', path: 'loaders/GLTFLoader.js' }],
    ignoreList: [],
  },
  {
...

  {
    ...
    dependencies: [
      { name: 'ConvexBufferGeometry', path: 'geometries/ConvexGeometry.js' },
    ],
    ignoreList: ['Matrix4'],
  },
  ...
  { path: 'misc/Gyroscope.js', dependencies: [], ignoreList: [] },
  {
    ...
    dependencies: [{ name: 'MD2Loader', path: 'loaders/MD2Loader.js' }],
    ignoreList: [],
  },
  {
    path: 'misc/MD2CharacterComplex.js',
    dependencies: [
      { name: 'MD2Loader', path: 'loaders/MD2Loader.js' },
      { name: 'MorphBlendMesh', path: 'misc/MorphBlendMesh.js' },
    ],
    ignoreList: [],
  },
  ...
  {
    path: 'misc/Ocean.js',
    dependencies: [{ name: 'OceanShaders', path: 'shaders/OceanShaders.js' }],
    ignoreList: [],
  },
  { path: 'misc/RollerCoaster.js', dependencies: [], ignoreList: [] },
  {
    path: 'misc/Volume.js',
    dependencies: [{ name: 'VolumeSlice', path: 'misc/VolumeSlice.js' }],
    ignoreList: [],
  },
  ...
  { path: 'objects/Lensflare.js', dependencies: [], ignoreList: [] },
  {
    ...
    dependencies: [
      { name: 'LightningStrike', path: 'geometries/LightningStrike.js' },
    ],
    ignoreList: ['Material'],
  },
  ...
  { path: 'objects/Refractor.js', dependencies: [], ignoreList: [] },
  {
    ...
    dependencies: [{ name: 'Reflector', path: 'objects/Reflector.js' }],
    ignoreList: [],
  },
  ...
  { path: 'objects/Water.js', dependencies: [], ignoreList: [] },
  {
    ...
    dependencies: [
      { name: 'Reflector', path: 'objects/Reflector.js' },
      { name: 'Refractor', path: 'objects/Refractor.js' },
    ],
    ignoreList: [],
  },

  {
    ...
    dependencies: [
      { name: 'Pass', path: 'postprocessing/Pass.js' },
      { name: 'CopyShader', path: 'shaders/CopyShader.js' },
      { name: 'LuminosityShader', path: 'shaders/LuminosityShader.js' },
      { name: 'ToneMapShader', path: 'shaders/ToneMapShader.js' },
    ],
    ignoreList: [],
  },
  {
    ...
    dependencies: [
      { name: 'Pass', path: 'postprocessing/Pass.js' },
      { name: 'AfterimageShader', path: 'shaders/AfterimageShader.js' },
    ],
    ignoreList: [],
  },
  {
    ...
    dependencies: [
      { name: 'Pass', path: 'postprocessing/Pass.js' },
      { name: 'CopyShader', path: 'shaders/CopyShader.js' },
      { name: 'ConvolutionShader', path: 'shaders/ConvolutionShader.js' },
    ],
    ignoreList: [],
  },
  {
    ...
    dependencies: [
      { name: 'Pass', path: 'postprocessing/Pass.js' },
      { name: 'BokehShader', path: 'shaders/BokehShader.js' },
    ],
    ignoreList: [],
  },
  {
    path: 'postprocessing/ClearPass.js',
    dependencies: [{ name: 'Pass', path: 'postprocessing/Pass.js' }],
    ignoreList: [],
  },
  {
  ...
  },
  {
    ...
    dependencies: [
      { name: 'Pass', path: 'postprocessing/Pass.js' },
      { name: 'DotScreenShader', path: 'shaders/DotScreenShader.js' },
    ],
    ignoreList: [],
  },
  {
    ...
    dependencies: [
      { name: 'CopyShader', path: 'shaders/CopyShader.js' },
      { name: 'ShaderPass', path: 'postprocessing/ShaderPass.js' },
      { name: 'MaskPass', path: 'postprocessing/MaskPass.js' },
      { name: 'ClearMaskPass', path: 'postprocessing/MaskPass.js' },
    ],
    ignoreList: [],
  },
  {
    ...
    dependencies: [
      { name: 'Pass', path: 'postprocessing/Pass.js' },
      { name: 'FilmShader', path: 'shaders/FilmShader.js' },
    ],
    ignoreList: [],
  },
  {
    ...
    dependencies: [
      { name: 'Pass', path: 'postprocessing/Pass.js' },
      { name: 'DigitalGlitch', path: 'shaders/DigitalGlitch.js' },
    ],
    ignoreList: [],
  },
  {
    ...
    dependencies: [
      { name: 'Pass', path: 'postprocessing/Pass.js' },
      { name: 'HalftoneShader', path: 'shaders/HalftoneShader.js' },
    ],
    ignoreList: [],
  },
  {
  ...
  },
  {
    ...
    dependencies: [
      { name: 'Pass', path: 'postprocessing/Pass.js' },
      { name: 'SAOShader', path: 'shaders/SAOShader.js' },
      {
        name: 'DepthLimitedBlurShader',
        path: 'shaders/DepthLimitedBlurShader.js',
      },
      { name: 'BlurShaderUtils', path: 'shaders/DepthLimitedBlurShader.js' },
      { name: 'CopyShader', path: 'shaders/CopyShader.js' },
      {
  ...
  },
  {
    ...
    dependencies: [
      { name: 'Pass', path: 'postprocessing/Pass.js' },
      { name: 'SMAAEdgesShader', path: 'shaders/SMAAShader.js' },
      { name: 'SMAAWeightsShader', path: 'shaders/SMAAShader.js' },
      { name: 'SMAABlendShader', path: 'shaders/SMAAShader.js' },
    ],
    ignoreList: [],
  },
  {
  ...
  },
  {
    ...
    dependencies: [
      { name: 'Pass', path: 'postprocessing/Pass.js' },
      { name: 'SimplexNoise', path: 'math/SimplexNoise.js' },
      { name: 'SSAOShader', path: 'shaders/SSAOShader.js' },
      { name: 'SSAOBlurShader', path: 'shaders/SSAOShader.js' },
      { name: 'SSAODepthShader', path: 'shaders/SSAOShader.js' },
      { name: 'CopyShader', path: 'shaders/CopyShader.js' },
    ],
    ignoreList: [],
  },
  {
    ...
    dependencies: [
      { name: 'SSAARenderPass', path: 'postprocessing/SSAARenderPass.js' },
    ],
    ignoreList: [],
  },
  {
  ...
  { path: 'renderers/Projector.js', dependencies: [], ignoreList: [] },
  {
    ...
    dependencies: [
      { name: 'Projector', path: 'renderers/Projector.js' },
      { name: 'RenderableFace', path: 'renderers/Projector.js' },
      { name: 'RenderableLine', path: 'renderers/Projector.js' },
      { name: 'RenderableSprite', path: 'renderers/Projector.js' },
    ],
    ignoreList: [],
  },

  {
    path: 'shaders/ACESFilmicToneMappingShader.js',
    dependencies: [],
    ignoreList: [],
  },
  ...
  {
    path: 'shaders/SubsurfaceScatteringShader.js',
    dependencies: [],
    ignoreList: [],
  },
...
function convert(path, exampleDependencies, ignoreList) {
  ...
  contents = contents.replace(/(\'?)THREE\.([a-zA-Z0-9]+)(\.{0,1})/g, function(
    match,
    p1,
    p2,
    p3,
  ...
  contents = contents.replace(/new THREE\.([a-zA-Z0-9]+)\(/g, function(
    match,
    p1,
  ) {
  ...
  contents = contents.replace(/(\'?)THREE\.([a-zA-Z0-9_]+)/g, function(
    match,
    p1,
    p2,
  ) {

...
THREE.MMDPhysics = (function() {
  ...
  RigidBody.prototype = {
    ...
    _init: function() {
      ...
      var bone =
        params.boneIndex === -1 ? new THREE.Bone() : bones[params.boneIndex];
      ...
      manager.setOriginFromThreeVector3(
        boneForm,
  ...
  MMDPhysicsHelper.prototype = Object.assign(
      ...
      _init: function() {
        ...
        function createGeometry(param) {
          switch (param.shapeType) {
            ...
            case 2:
              return new createCapsuleGeometry(
                param.width,
                param.height,
                16,
                8,
        ...
        function createCapsuleGeometry(
          ...
          var upperSphere = new THREE.Mesh(
          ...
          var lowerSphere = new THREE.Mesh(
            new THREE.SphereBufferGeometry(
              radius,
              segmentsRadius,
              segmentsHeight,
        ...
        for (var i = 0, il = bodies.length; i < il; i++) {
          ...
          this.add(
            new THREE.Mesh(createGeometry(param), this.materials[param.type]),
          );
        }
      },
    },

  ...
  parseBlock: function() {
    ...
    switch (blockID) {
      ...
      case 'NNME':
        ...
        this.IFF.currentSurface.nodes[
          this.IFF.currentForm.refName
...
THREE.LWOLoader.prototype = Object.assign(
      ...
      switch (name) {
        ...
        case 'Normal':
          ...
          if (node.amplitude !== undefined)
            maps.normalScale = new THREE.Vector2(
              node.amplitude,
              node.amplitude,
            );
          break;
  ...
  parseStandardAttributes(params, attributes, maps) {
    if (attributes.Luminous) {
      ...
      if (attributes['Luminous Color'] && !maps.emissive) {
        params.emissive = new THREE.Color().fromArray(
  ...
  parsePhongAttributes(params, attributes, maps) {
    ...
    if (!attributes.Roughness && attributes.Specular && !maps.specularMap) {
      if (attributes['Color Highlight']) {
        ...
        params.specular = new THREE.Color().setScalar(
          attributes.Specular.value,
        );
      }
    }
...
GeometryParser.prototype = {
  ...
  parse(geoData, layer) {
    ...
    geometry.setAttribute(
      'position',
      new THREE.Float32BufferAttribute(geoData.points, 3),
    );
  ...
  parseUVs(geometry, layer) {
    ...
    geometry.setAttribute(
      'uv',
      new THREE.Float32BufferAttribute(remappedUVs, 2),
    );
  },
  ...
  parseMorphTargets(geometry, layer) {
    ...
    for (var name in layer.morphTargets) {
      ...
      geometry.morphAttributes.position[num] = new THREE.Float32BufferAttribute(
        remappedPoints,
        3,
      );

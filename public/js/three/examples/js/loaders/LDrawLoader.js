...
THREE.LDrawLoader = (function() {
  ...
  LDrawLoader.prototype = Object.assign(Object.create(THREE.Loader.prototype), {
    ...
    parseColourMetaDirective: function(lineParser) {
      ...
      if (!name) {
        throw 'LDrawLoader: Material name was expected after "!COLOUR tag' +
        ...
        switch (token.toUpperCase()) {
          ...
          case 'VALUE':
            ...
            if (colour.startsWith('0x')) {
              ...
              throw 'LDrawLoader: Invalid colour while parsing material' +
                lineParser.getLineNumberString() +
                '.';
            }
          ...
          case 'EDGE':
            ...
            if (edgeColour.startsWith('0x')) {
              ...
              if (!edgeMaterial) {
                throw 'LDrawLoader: Invalid edge colour while parsing material' +
                  lineParser.getLineNumberString() +
                  '.';
              }
          ...
          case 'ALPHA':
            ...
            if (isNaN(alpha)) {
              throw 'LDrawLoader: Invalid alpha value in material definition' +
                lineParser.getLineNumberString() +
                '.';
            }
          ...
          case 'LUMINANCE':
            ...
            if (isNaN(luminance)) {
              throw 'LDrawLoader: Invalid luminance value in material definition' +
                LineParser.getLineNumberString() +
                '.';
            }
          ...
          default:
            throw 'LDrawLoader: Unknown token "' +
              token +
    ...
    objectParse: function(text) {
      ...
      function parseColourCode(lineParser, forEdge) {
        ...
        if (!material) {
          throw 'LDrawLoader: Unknown colour code "' +
            colourCode +
            '" is used' +
            lineParser.getLineNumberString() +
      ...
      for (lineIndex = 0; lineIndex < numLines; lineIndex++) {
        ...
        if (parsingEmbeddedFiles) {
          if (line.startsWith('0 FILE ')) {
            ...
            this.subobjectCache[
              currentEmbeddedFileName.toLowerCase()
            ] = currentEmbeddedText;
        ...
        switch (lineType) {
          ...
          default:
            throw 'LDrawLoader: Unknown line type "' +
              lineType +
              '"' +
              lp.getLineNumberString() +
              '.';

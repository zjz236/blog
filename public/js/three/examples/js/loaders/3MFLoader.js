...
THREE.ThreeMFLoader.prototype = Object.assign(
    ...
    parse: function(data) {
      ...
      function loadDocument(data) {
        ...
        if (modelRelsName) {
          var relsView = new Uint8Array(
            zip.file(modelRelsName).asArrayBuffer(),
          );
          var relsFileText = THREE.LoaderUtils.decodeText(relsView);
      ...
      function parseColorGroupNode(colorGroupNode) {
        var colorGroupData = {
          ...
          displaypropertiesid: colorGroupNode.getAttribute(
            'displaypropertiesid',
          ),
        };
      ...
      function parseBasematerialNode(basematerialNode) {
        ...
        basematerialData['displaycolor'] = basematerialNode.getAttribute(
          'displaycolor',
        ); // required
      ...
      function parseResourcesNode(resourcesNode) {
        ...
        var basematerialsNodes = resourcesNode.querySelectorAll(
          'basematerials',
        );
        ...
        var textures2DGroupNodes = resourcesNode.querySelectorAll(
          'texture2dgroup',
        );

        for (var i = 0; i < textures2DGroupNodes.length; i++) {
          var textures2DGroupNode = textures2DGroupNodes[i];
          var textures2DGroupData = parseTextures2DGroupNode(
            textures2DGroupNode,
          );
          resourcesData['texture2dgroup'][
      ...
      function buildTexturedMesh(
        ...
        geometry.setAttribute(
          'uv',
          new THREE.Float32BufferAttribute(uvData, 2),
        );
      ...
      function buildVertexColorMesh(
        ...
        geometry.setAttribute(
          'color',
          new THREE.Float32BufferAttribute(colorData, 3),
        );
      ...
      function buildMeshes(
        ...
        for (var i = 0, il = keys.length; i < il; i++) {
          ...
          switch (resourceType) {
            ...
            case 'texture':
              var texture2dgroup =
                modelData.resources.texture2dgroup[resourceId];
              meshes.push(
                buildTexturedMesh(
                  texture2dgroup,
                  triangleProperties,
      ...
      function analyzeObject(modelData, meshData, objectData) {
        ...
        for (var i = 0, l = triangleProperties.length; i < l; i++) {
          var triangleProperty = triangleProperties[i];
          var pid =
            triangleProperty.pid !== undefined
              ? triangleProperty.pid
              : objectPid;

...
THREE.BasisTextureLoader.prototype = Object.assign(
  Object.create(THREE.Loader.prototype),
  {
    ...
    detectSupport: function(renderer) {
      ...
      config.astcSupported = !!renderer.extensions.get(
        'WEBGL_compressed_texture_astc',
      );
      config.bptcSupported = !!renderer.extensions.get(
        'EXT_texture_compression_bptc',
      );
      config.etcSupported = !!renderer.extensions.get(
        'WEBGL_compressed_texture_etc1',
      );
      config.dxtSupported = !!renderer.extensions.get(
...
THREE.BasisTextureLoader.DXT_FORMAT_MAP[
  THREE.BasisTextureLoader.BASIS_FORMAT.cTFBC1
] = THREE.BasisTextureLoader.DXT_FORMAT.COMPRESSED_RGB_S3TC_DXT1_EXT;
THREE.BasisTextureLoader.DXT_FORMAT_MAP[
  THREE.BasisTextureLoader.BASIS_FORMAT.cTFBC3

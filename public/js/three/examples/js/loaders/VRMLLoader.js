    ...
    parse: function(data, path) {
      ...
      function buildMaterialNode(node) {
        ...
        for (var i = 0, l = fields.length; i < l; i++) {
          ...
          switch (fieldName) {
            ...
            case 'diffuseColor':
              materialData.diffuseColor = new THREE.Color(
                fieldValues[0],
                fieldValues[1],
                fieldValues[2],
              );
            ...
            case 'emissiveColor':
              materialData.emissiveColor = new THREE.Color(
                fieldValues[0],
                fieldValues[1],
                fieldValues[2],
              );
          ...
          switch (fieldName) {
            case 'image':
              ...
              texture = new THREE.DataTexture(
                ...
                width,
                height,
                useAlpha === true ? THREE.RGBAFormat : THREE.RGBFormat,
              );
      ...
      function buildIndexedFaceSetNode(node) {
        ...
        positionAttribute = toNonIndexedAttribute(
          triangulatedCoordIndex,
          new THREE.Float32BufferAttribute(coord, 3),
        );
      ...
      function paintFaces(geometry, radius, angles, colors, topDown) {
        ...
        var colorAttribute = new THREE.BufferAttribute(

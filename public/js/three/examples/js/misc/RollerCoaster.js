...
THREE.RollerCoasterGeometry = function(curve, divisions) {
  ...
  for (var i = 0; i < sides; i++) {
    ...
    tube1.push(
      new THREE.Vector3(Math.sin(angle) * 0.06, Math.cos(angle) * 0.06, 0),
    );
  }
  ...
  for (var i = 0; i < sides; i++) {
    var angle = (i / sides) * PI2;
    tube2.push(
      new THREE.Vector3(Math.sin(angle) * 0.025, Math.cos(angle) * 0.025, 0),
    );
  }
...
THREE.RollerCoasterGeometry.prototype = Object.create(
...
THREE.RollerCoasterLiftersGeometry.prototype = Object.create(
  THREE.BufferGeometry.prototype,
);
...
THREE.RollerCoasterShadowGeometry.prototype = Object.create(
  THREE.BufferGeometry.prototype,
);

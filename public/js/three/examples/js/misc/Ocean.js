...
THREE.Ocean = function(renderer, camera, scene, options) {
  ...
  this.oceanColor = optionalParameter(
    options.OCEAN_COLOR,
    new THREE.Vector3(0.004, 0.016, 0.047),
  );
  this.skyColor = optionalParameter(
    options.SKY_COLOR,
    new THREE.Vector3(3.2, 9.6, 12.8),
  );
  ...
  var oceanHorizontalUniforms = THREE.UniformsUtils.clone(
  ...
  var oceanVerticalUniforms = THREE.UniformsUtils.clone(
    oceanVerticalShader.uniforms,
  );
  ...
  var initialSpectrumUniforms = THREE.UniformsUtils.clone(

...
THREE.LightningStrike.prototype.init = function(rayParameters) {
  ...
  this.generateUVs =
    rayParameters.generateUVs !== undefined ? rayParameters.generateUVs : false;
...
THREE.LightningStrike.prototype.createMesh = function() {
  ...
  if (this.generateUVs) {
    this.uvsAttribute = new THREE.Float32BufferAttribute(
...
THREE.LightningStrike.prototype.createTriangleVerticesWithoutUVs = function(
  pos,
  up,
  forwards,
  radius,
  ...
  this.side
    ...
    .multiplyScalar(radius * THREE.LightningStrike.COS30DEG);
...
THREE.LightningStrike.prototype.createTriangleVerticesWithUVs = function(
  pos,
  up,
  forwards,
  radius,
...
THREE.LightningStrike.prototype.createPrismFaces = function(
  vertex /*, index*/,
) {
...
THREE.LightningStrike.prototype.clone = function() {
  return new this.constructor(
    THREE.LightningStrike.copyParameters({}, this.rayParameters),
  );
};

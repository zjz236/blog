  ...
  hilbert2D: function(center, size, iterations, v0, v1, v2, v3) {
    ...
    if (0 <= --iterations) {
      ...
      Array.prototype.push.apply(
        tmp,
        THREE.GeometryUtils.hilbert2D(vec[0], half, iterations, v0, v3, v2, v1),
      );
      Array.prototype.push.apply(
        tmp,
        THREE.GeometryUtils.hilbert2D(vec[1], half, iterations, v0, v1, v2, v3),
      );
      Array.prototype.push.apply(
        tmp,
        THREE.GeometryUtils.hilbert2D(vec[2], half, iterations, v0, v1, v2, v3),
      );
      Array.prototype.push.apply(
        tmp,
        THREE.GeometryUtils.hilbert2D(vec[3], half, iterations, v2, v1, v0, v3),
      );

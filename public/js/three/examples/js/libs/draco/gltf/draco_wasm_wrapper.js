  ...
  function(d) {
    ...
    h.race = function(d) {
      return new h(function(h, k) {
        for (
          var v = $jscomp.makeIterator(d), r = v.next();
          !r.done;
          r = v.next()
        )
      ...
      return r.done
        ...
        : new h(function(d, h) {
            ...
            do
              u.push(void 0),
                B++,
                f(r.value).callWhenSettled_(v(u.length - 1), h),
                (r = k.next());
            while (!r.done);
          });
    };
...
var DracoDecoderModule = function(d) {
    ...
    if (128 > b) {
      for (; 0 < c; )
        (b = String.fromCharCode.apply(
          String,
          W.subarray(a, a + Math.min(c, 1024)),
        )),
          (e = e ? e + b : b),
          (a += 1024),
          (c -= 1024);
  ...
  function la() {
    ...
    for (var d = 0; d < p.length; d++)
      if (p[d] && a.___cxa_can_catch(p[d], b, e))
        return (e = E[e >> 2]), (c.adjusted = e), (sa(p[d]), e) | 0;
    e = E[e >> 2];
    return (sa(b), e) | 0;
  }
  function Z(e, c) {
    ...
    try {
      ...
      Z.buffers ||
        ...
        (Z.printChar = function(c, b) {
          ...
          f(e);
          0 === b || 10 === b
            ? ((1 === c ? a.print : a.printErr)(h(e, 0)), (e.length = 0))
            : e.push(b);
        }));
      for (c = 0; c < d; c++) {
        for (
          var g = E[(p + 8 * c) >> 2], k = E[(p + (8 * c + 4)) >> 2], l = 0;
          l < k;
          l++
        )
          Z.printChar(b, W[g + l]);
      ...
      return (
        ('undefined' !== typeof FS && ya instanceof FS.ErrnoError) || O(ya),
        -ya.errno
      );
    }
  }
  ...
  function U(a) {
    if ('string' === typeof a) {
      for (var c = 0, b = 0; b < a.length; ++b) {
        ...
        55296 <= e &&
          57343 >= e &&
          (e = (65536 + ((e & 1023) << 10)) | (a.charCodeAt(++b) & 1023));
        127 >= e
          ? ++c
          : (c =
              2047 >= e
  ...
  if (a.buffer) var D = a.buffer;
    ...
    'object' === typeof WebAssembly && 'function' === typeof WebAssembly.Memory
      ? ((a.wasmMemory = new WebAssembly.Memory({ initial: A / 65536 })),
        (D = a.wasmMemory.buffer))
      : (D = new ArrayBuffer(A)),
      (a.buffer = D);
  r();
  E[0] = 1668509029;
  ...
  (function() {
    ...
    function b(b, e, d) {
      ...
      if (a.instantiateWasm)
        try {
          ...
          return (
            a.printErr(
              'Module.instantiateWasm callback failed with error: ' + pb,
            ),
            !1
          );
        }
    ...
    'function' === typeof a.locateFile &&
      (Y(d) || (d = a.locateFile(d)),
      Y(f) || (f = a.locateFile(f)),
      Y(g) || (g = a.locateFile(g)));
    var h = {
        global: null,
        env: null,
        asm2wasm: {
  ...
  var y = {
      ...
      decRef: function(e) {
        if (e) {
          ...
          0 !== c.refcount ||
            c.rethrown ||
            (c.destructor && a.dynCall_vi(c.destructor, e),
            delete y.infos[e],
  ...
  a.asmLibraryArg = {
    ...
    enlargeMemory: function() {
      ...
      for (A = Math.max(A, 16777216); A < E[ka >> 2]; )
        A =
          536870912 >= A
            ? ha(2 * A, e)
            : Math.min(ha((3 * A + 2147483648) / 4, e), c);
      e = a.reallocBuffer(A);
    ...
    ___syscall140: function(a, c) {
      ...
      try {
        ...
        return (
          ('undefined' !== typeof FS && ca instanceof FS.ErrnoError) || O(ca),
          -ca.errno
        );
      }
    },
    ...
    ___syscall6: function(a, c) {
      ...
      try {
        ...
        return (
          ('undefined' !== typeof FS && p instanceof FS.ErrnoError) || O(p),
          -p.errno
        );
      }
    },
  ...
  a.exit = function(c, b) {
    if (!b || !a.noExitRuntime || 0 !== c) {
      if (!a.noExitRuntime && ((oa = !0), (ta = void 0), B(ob), a.onExit))
        a.onExit(c);
      qa && process.exit(c);
      a.quit(c, new na(c));
    }
  ...
  var l = {
    ...
    prepare: function() {
      ...
      l.buffer ||
        ((l.size += 128), (l.buffer = a._malloc(l.size)), f(l.buffer));
      l.pos = 0;
    },
    alloc: function(c, b) {
      f(l.buffer);

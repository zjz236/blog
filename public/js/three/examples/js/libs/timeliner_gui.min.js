(function e(t, n, r) {
...
})(
  {
      ...
      function(require, module, exports) {
        function Do(o) {
          ...
          (this['do'] = function(o) {
            ...
            (this.fire = function() {
              for (var t = 0; t < n.length; t++) n[t].apply(o, arguments);
            });
        }
      ...
      function(require, module, exports) {
        module.exports = {
          ...
          scripts: {
            ...
            mini:
              'browserify src/*.js -g uglifyify --full-path=false -o timeliner_gui.min.js',
        ...
        function LayerCabinet(e) {
          ...
          function n() {
            ...
            for (var o = x.length; o-- > 0; )
              o >= t.length
                ? ((x[o].dom.style.display = 'none'), T.push(x.pop()))
                : (x[o].setState(t[o]), x[o].repaint(n));
          }
          var o = document.createElement('div'),
            a = document.createElement('div');
          a.style.cssText =
            'margin: 0px; top: 0; left: 0; height: ' +
            LayoutConstants.MARKER_TRACK_HEIGHT +
            'px';
          ...
          var x = [],
            T = [];
          (this.layers = x),
            (this.setControlStatus = function(e) {
              (p = e),
                p
                  ? (s.setIcon('pause'), s.setTip('Pause'))
                  : (s.setIcon('play'), s.setTip('Play'));
            }),
            (this.updateState = function() {
              ...
              for (t = 0; t < o.length; t++) {
                if (((n = o[t]), !x[t])) {
                  var a;
                  T.length
                    ? ((a = T.pop()), (a.dom.style.display = 'block'))
                    : ((a = new LayerUI(e, n)), i.appendChild(a.dom)),
                    x.push(a);
                }
                x[t].setState(n);
              }
    ...
    5: [
        ...
        function LayerView(e, t) {
          ...
          (r.innerHTML = '&#9672;'),
            (r.style.cssText =
              ...
              i +
              'px; border-style:none; outline: none;'),
          ...
          var a = function(n) {
            if (
              ((r.style.color = Theme.b),
              null != n && !e.draggingKeyframe && null != t)
            ) {
      ...
      { './layout_constants': 6, './theme': 7, './utils': 11 },
    ],
    6: [
      function(require, module, exports) {
        module.exports = {
      ...
      function(require, module, exports) {
        ...
        function TimelinePanel(e) {
          function t(t, n, l) {
            ...
            (this.time = t),
              (this.path = function(e) {
                e.beginPath()
                  .moveTo(n, l)
                  .lineTo(n + DIAMOND_SIZE / 2, l + DIAMOND_SIZE / 2)
                  .lineTo(n, l + DIAMOND_SIZE)
                  .lineTo(n - DIAMOND_SIZE / 2, l + DIAMOND_SIZE / 2)
                  .closePath();
              }),
              (this.paint = function(e) {
                a.path(e),
                  r ? e.fillStyle('yellow') : e.fillStyle(Theme.c),
                  e.fill().stroke();
              }),
              ...
              (this.mousedrag = function(t, n) {
                if (void 0 !== M) {
                  var l = f(t.offsetx),
                    ...
                    r = n.shiftKey;
                  a &&
                    ((e.draggingKeyframe = !0),
                    e.controller.moveKeyframe(M, C, a, r),
                    (C += a),
                    i());
                }
              });
          ...
          function n() {
            ...
            for (I = 0; R > I; I++) {
              ...
              for (var l = 0; l < n.length; l++) {
                var a = n[l];
                S.push(
                  new t(a, h(a), H + 0.5 * LINE_HEIGHT - DIAMOND_SIZE / 2),
                );
              }
            }
          ...
          function l() {
            ...
            var a = w;
            (P.left = e.scrollTime * l),
              (P.left = Math.min(Math.max(0, P.left), t - P.grip_length)),
              A.beginPath(),
              (A.fillStyle = Theme.b),
              A.rect(0, 5, t, a),
              A.fill(),
              (A.fillStyle = Theme.c),
              A.beginPath(),
              A.rect(P.left, 5, P.grip_length, a),
              A.fill();
            var r = k * l;
          ...
          function r() {
            ...
            t && t != D && ((e = t), e.mouseout && e.mouseout()),
              D && ((e = D), e.mouseover && e.mouseover(), O && (G = e));
          }
          function o() {
            b &&
              x
                ...
                .beginPath()
                .rect(0, 0, e.width, e.scrollHeight)
                .translate(-g, -d)
                .clip()
                .run(r)
                .restore();
          ...
          function s() {
            ...
            a(e.timeScale),
              (k = e.currentTime),
              (frame_start = e.scrollTime),
              (A.fillStyle = Theme.a),
              A.clearRect(0, 0, v.width, v.height),
              A.save(),
              A.scale(E, E),
              (A.lineWidth = 1),
              (width = e.width),
            ...
            for (
              t = time_scale / tickMark2, r = (width - p + i) / t, I = 0;
              r > I;
              I++
            )
              (A.strokeStyle = Theme.c),
                A.beginPath(),
                (y = I * t + p - i),
                A.moveTo(y, MARKER_TRACK_HEIGHT - 0),
                A.lineTo(y, MARKER_TRACK_HEIGHT - 16),
                A.stroke();
            var c = tickMark3 / tickMark2;
            for (
              t = time_scale / tickMark3, r = (width - p + i) / t, I = 0;
              r > I;
              I++
            )
              I % c !== 0 &&
                ...
                (y = I * t + p - i),
                A.moveTo(y, MARKER_TRACK_HEIGHT - 0),
                A.lineTo(y, MARKER_TRACK_HEIGHT - 10),
                A.stroke());
            x
              .save()
              .translate(0, MARKER_TRACK_HEIGHT)
          ...
          function c(e) {
            return 0 > e - MARKER_TRACK_HEIGHT
              ? -1
              : ((e - MARKER_TRACK_HEIGHT + d) / LINE_HEIGHT) | 0;
          }
          function f(e) {
          ...
          (this.updateState = function() {
            ...
            (this.scrollTo = function(t) {
              (d = t * Math.max(_.length * LINE_HEIGHT - e.scrollHeight, 0)),
                i();
            }),
            (this.resize = function() {
              (E = window.devicePixelRatio),
                ...
                (e.scrollHeight = e.height - MARKER_TRACK_HEIGHT);
            }),
            (this.dom = v),
            this.resize();
          var k,
          ...
          utils.handleDrag(
            ...
            function(e) {
              (O = !0),
                ...
                o(),
                G instanceof t &&
                  ((C = G.time), (M = _[c(e.offsety)]), M || (G = null)),
                T.fire('time.update', f(e.offsetx));
            },
            function(e, t) {
              (O = !1),
                G
                  ? ((Z = !0), G.mousedrag && G.mousedrag(e, t))
                  : T.fire('time.update', f(e.offsetx));
            },
            function() {
              Z && T.fire('keyframe.move'),
                (O = !1),
                (G = null),
                (Z = !1),
                (e.draggingKeyframe = !1),
                i();
            },
          );
          var q;
          utils.handleDrag(
            ...
            function(e) {
              var t =
                e.offsetx >= P.left && e.offsetx <= P.left + P.grip_length;
    ...
    9: [
      function(require, module, exports) {
        function LayerProp(e) {
          (this.name = e),
            (this.values = []),
            (this._color = '#' + ((16777215 * Math.random()) | 0).toString(16));
        }
        function Timeliner(e) {
          function t() {
            (E = performance.now() - 1e3 * w.currentTime),
              v.setControlStatus(!0);
          }
          function n() {
          ...
          function i() {
            ...
            H &&
              ((T.style.width = w.width + 'px'),
              (T.style.height = w.height + 'px'),
              g(v.dom, y.dom),
              y.resize(),
              h(),
              (H = !1),
          ...
          function a(e) {
            e || (e = w.name),
              (e = prompt('Pick a name to save to (localStorage)', e)),
              e && ((w.name = e), o(e));
          }
          function r() {
            var e = w.name;
          ...
          function m(e, t) {
            (w.width = e - LayoutConstants.LEFT_PANE_WIDTH - 4),
              (w.height = t - 44),
              (w.scrollHeight = w.height - LayoutConstants.MARKER_TRACK_HEIGHT),
              x.setHeight(w.scrollHeight - 2),
              style(x.dom, {
                top: LayoutConstants.MARKER_TRACK_HEIGHT + 'px',
                left: e - 16 - 4 + 'px',
              }),
          ...
          function g(e, t) {
            (e.style.cssText =
              ...
              (e.style.width = LayoutConstants.LEFT_PANE_WIDTH + 'px'),
              (t.style.position = 'absolute'),
              (t.style.top = '0px'),
              (t.style.left = LayoutConstants.LEFT_PANE_WIDTH + 'px');
          }
          ...
          e.setDuration(w.totalTime),
            f.on('keyframe', function(t) {
              var n = w.currentTime;
              if (null != n && null != t) {
                var i = e.getChannelKeyTimes(t, n);
                utils.binarySearch(i, n) < 0
                  ? e.setKeyframe(t, n)
                  : e.delKeyframe(t, n),
                  h();
              }
          ...
          f.on('controls.toggle_play', function() {
            ...
            f.on('controls.play', t),
            f.on('controls.pause', n),
            f.on('controls.stop', function() {
              null !== E && n(), b(0);
            }),
            f.on('time.update', b),
            f.on('totalTime.update', function(t) {
              (w.totalTime = t), e.setDuration(t), y.repaint();
            }),
            f.on('update.scale', function(e) {
              (w.timeScale = e), y.setTimeScale(e), y.repaint();
            }),
            f.on('controls.undo', function() {}),
            f.on('controls.redo', function() {});
          var H = !0;
          i(),
            (this.openLocalSave = p),
            f.on(
              'import',
              function() {
                u();
          ...
          k.appendChild(I),
            (I.innerHTML =
              package_json.description + ' ' + package_json.version),
            k.appendChild(I);
          ...
          style(P, {
            ...
            document.addEventListener('keydown', function(e) {
              var t = 32 == e.keyCode,
                n = 13 == e.keyCode,
                i =
                  (e.metaKey && 91 == e.keyCode && !e.shiftKey,
                  document.activeElement);
              i.nodeName.match(/(INPUT|BUTTON|SELECT)/) && i.blur(),
                t
                  ? f.fire('controls.toggle_play')
                  : n
                  ? f.fire('controls.restart_play')
                  : 27 == e.keyCode && f.fire('controls.pause');
            }),
            ...
            (function() {
              ...
              function u() {
                if ((requestAnimationFrame(u), X)) {
                  if (((X = !1), W && W.isResizing)) {
                    if (
                      (W.onRightEdge && (L.style.width = Math.max(E, b) + 'px'),
                      W.onBottomEdge &&
                        (L.style.height = Math.max(C, _) + 'px'),
                      W.onLeftEdge)
                    ) {
                      var n = Math.max(W.cx - q.clientX + W.w, b);
                      n > b &&
                        ((L.style.width = n + 'px'),
                        (L.style.left = q.clientX + 'px'));
                    }
                    if (W.onTopEdge) {
                      var i = Math.max(W.cy - q.clientY + W.h, _);
                      i > _ &&
                        ((L.style.height = i + 'px'),
                        (L.style.top = q.clientY + 'px'));
                    }
                  ...
                  if (W && W.isMoving) {
                    switch (p()) {
                      case 'full-screen':
                        e(P, 0, 0, window.innerWidth, window.innerHeight),
                          (P.style.opacity = 0.2);
                        break;
                      case 'snap-top-edge':
                        e(
                    ...
                    return z
                      ? void e(
                          L,
                          q.clientX - z.width / 2,
                          q.clientY - Math.min(W.y, z.height),
                          z.width,
                          z.height,
                        )
                      : ((L.style.top = q.clientY - W.y + 'px'),
                        void (L.style.left = q.clientX - W.x + 'px'));
                  }
                  (y && v) || (x && T)
                    ? (L.style.cursor = 'nwse-resize')
                    : (y && T) || (v && x)
                    ? (L.style.cursor = 'nesw-resize')
                    : y || x
                    ? (L.style.cursor = 'ew-resize')
                    : v || T
                    ? (L.style.cursor = 'ns-resize')
                    : d()
                    ? (L.style.cursor = 'move')
              ...
              function p() {
                return q.clientY < S
                  ...
                  : q.clientX < I
                  ? 'snap-left-edge'
                  : window.innerWidth - q.clientX < I
                  ? 'snap-right-edge'
                  : window.innerHeight - q.clientY < I
                  ? 'snap-bottom-edge'
                  : void 0;
              }
              function g() {
                ...
                switch (D) {
                  ...
                  case 'snap-top-edge':
                    (t = 0),
                      (n = 0),
                      (i = window.innerWidth),
                      (o = 0.25 * window.innerHeight);
                    break;
                  case 'snap-left-edge':
                    (t = 0),
                      (n = 0),
                      (i = 0.35 * window.innerWidth),
                      (o = window.innerHeight);
                    break;
                  case 'snap-right-edge':
                    (t = 0.65 * window.innerWidth),
                      (n = 0),
                      (i = 0.35 * window.innerWidth),
                      (o = window.innerHeight);
                    break;
              ...
              function f(e) {
                c(e),
                  W &&
                    ...
                    ((D = p()),
                    D
                      ? ((z = { width: N.width, height: N.height }), g())
                      : (z = null),
                    t()),
                  (W = null),
                  B && e.stopPropagation();
              ...
              k.addEventListener('mouseover', function() {
                ...
                A.onClick(function() {
                  z || (z = { width: N.width, height: N.height }),
                    (D = 'full-screen'),
                    g();
                }),
                ...
                e(L, 0, 0, w.width, w.height),
                e(P, 0, 0, w.width, w.height),
                L.addEventListener('mousedown', s),
                L.addEventListener('mouseover', n),
                L.addEventListener('mouseout', i),
                document.addEventListener('mousemove', h),
                document.addEventListener('mouseup', f),
                L.addEventListener('touchstart', o),
      ...
      function(require, module, exports) {
        ...
        (UndoManager.prototype.save = function(t, e) {
          var n = this.states,
            ...
            s = n.length - i;
          n.splice(i, s, t),
            n.length > this.MAX_ITEMS && n.shift(),
            (this.index = n.length - 1),
            e || this.dispatcher.fire('state:save', t.description);
        }),
        ...
        module.exports = {
          ...
          fonts: {
            plus: {
              advanceWidth: 1408,
              commands:
                'M,1408,800 C,1408,853,1365,896,1312,896 L,896,896 L,896,1312 C,896,1365,853,1408,800,1408 L,608,1408 C,555,1408,512,1365,512,1312 L,512,896 L,96,896 C,43,896,0,853,0,800 L,0,608 C,0,555,43,512,96,512 L,512,512 L,512,96 C,512,43,555,0,608,0 L,800,0 C,853,0,896,43,896,96 L,896,512 L,1312,512 C,1365,512,1408,555,1408,608 Z',
            },
            minus: {
              advanceWidth: 1408,
              commands:
                'M,1408,800 C,1408,853,1365,896,1312,896 L,96,896 C,43,896,0,853,0,800 L,0,608 C,0,555,43,512,96,512 L,1312,512 C,1365,512,1408,555,1408,608 Z',
            },
            ok: {
              advanceWidth: 1792,
              commands:
                'M,1671,970 C,1671,995,1661,1020,1643,1038 L,1507,1174 C,1489,1192,1464,1202,1439,1202 C,1414,1202,1389,1192,1371,1174 L,715,517 L,421,812 C,403,830,378,840,353,840 C,328,840,303,830,285,812 L,149,676 C,131,658,121,633,121,608 C,121,583,131,558,149,540 L,511,178 L,647,42 C,665,24,690,14,715,14 C,740,14,765,24,783,42 L,919,178 L,1643,902 C,1661,920,1671,945,1671,970 Z',
            },
            remove: {
              advanceWidth: 1408,
              commands:
                'M,1298,214 C,1298,239,1288,264,1270,282 L,976,576 L,1270,870 C,1288,888,1298,913,1298,938 C,1298,963,1288,988,1270,1006 L,1134,1142 C,1116,1160,1091,1170,1066,1170 C,1041,1170,1016,1160,998,1142 L,704,848 L,410,1142 C,392,1160,367,1170,342,1170 C,317,1170,292,1160,274,1142 L,138,1006 C,120,988,110,963,110,938 C,110,913,120,888,138,870 L,432,576 L,138,282 C,120,264,110,239,110,214 C,110,189,120,164,138,146 L,274,10 C,292,-8,317,-18,342,-18 C,367,-18,392,-8,410,10 L,704,304 L,998,10 C,1016,-8,1041,-18,1066,-18 C,1091,-18,1116,-8,1134,10 L,1270,146 C,1288,164,1298,189,1298,214 Z',
            },
            zoom_in: {
              advanceWidth: 1664,
              commands:
      ...
      function(require, module, exports) {
        function IconButton(e, t, n, o) {
          ...
          (this.resize = function() {
            ...
            o && o.on('resize', this.resize),
            (this.setSize = function(t) {
              (e = t), this.resize();
            }),
            (this.setIcon = function(e) {
              (d.icon = e),
                font.fonts[e] || console.error('Font icon not found!'),
                this.resize();
            }),
          ...
          (IconButton.prototype.draw = function() {
            if (this.icon) {
              ...
              if (
                ...
                e.save(),
                  (e.fillStyle = Theme.b),
                  e.translate(1.5 * o, 1.5 * o),
                  e.scale(s, -s),
                  e.translate(0, -font.ascender),
                  e.beginPath();
          ...
          function r(t) {
            t.preventDefault(),
              t.target == d
                ...
                : t.clientY < m
                ? v.onScroll.fire('pageup')
                : t.clientY > m + h && v.onScroll.fire('pagedown');
          }
          function i(t) {
            t.preventDefault();
            var e = p - h,

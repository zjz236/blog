...
THREE.DRACOExporter.prototype = {
  ...
  parse: function(geometry, options) {
    ...
    if (geometry.isBufferGeometry !== true) {
      throw new Error(
        'THREE.DRACOExporter.parse(geometry, options): geometry is not a THREE.Geometry or THREE.BufferGeometry instance.',
      );
    }
    ...
    if (faces !== null) {
      ...
      var faces = new (vertices.count > 65535 ? Uint32Array : Uint16Array)(
        vertices.count,
      );

...
THREE.AdaptiveToneMappingPass = function(adaptive, resolution) {
  ...
  if (THREE.LuminosityShader === undefined)
    console.error(
      'THREE.AdaptiveToneMappingPass relies on THREE.LuminosityShader',
    );
  ...
  if (THREE.ToneMapShader === undefined)
    console.error(
      'THREE.AdaptiveToneMappingPass relies on THREE.ToneMapShader',
    );
...
THREE.AdaptiveToneMappingPass.prototype = Object.assign(

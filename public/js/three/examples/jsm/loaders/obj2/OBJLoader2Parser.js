...
OBJLoader2Parser.prototype = {
  ...
  execute: function(arrayBuffer) {
    ...
    for (
      let code, word = '', bufferPointer = 0, slashesCount = 0, i = 0;
      i < length;
      i++
    ) {
  ...
  executeLegacy: function(text) {
    ...
    for (
      let char, word = '', bufferPointer = 0, slashesCount = 0, i = 0;
      i < length;
      i++
    ) {
      char = text[i];

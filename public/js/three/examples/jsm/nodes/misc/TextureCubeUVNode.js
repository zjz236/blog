...
TextureCubeUVNode.Nodes = (function() {
  ...
  var cubeUV_maxTileSize = new ConstNode(
...
TextureCubeUVNode.prototype.bilinearCubeUV = function(
  builder,
  texture,
  uv,
  mipInt,
) {
  var bilinearCubeUV = new FunctionCallNode(
...
TextureCubeUVNode.prototype.generate = function(builder, output) {
  if (builder.isShader('fragment')) {
    ...
    var mipV = new FunctionCallNode(TextureCubeUVNode.Nodes.roughnessToMip, [
      bias,
    ]);
    var mip = new MathNode(
      mipV,
    ...
    var color1 = this.bilinearCubeUV(
      builder,
      this.value,
      uv,
      new OperatorNode(
    ...
    console.warn(
      'THREE.TextureCubeUVNode is not compatible with ' +
        builder.shader +
        ' shader.',
    );
